...
export default function DonorLayout({ user, onLogout, children }) {
  ...
  return (
    <div style={{
      ...
      <div className="donor-sidebar-desktop" style={{ display: 'flex' }}>
        <DonorSidebar user={user} onLogout={onLogout} />
      </div>
      ...
      <main className="portal-main-content" style={{
        ...
        <div className="donor-mobile-toggle" style={{ display: 'none', marginBottom: '1rem' }}>
          <button
          ...
          >
            <Menu size={18} /> Donor Navigation Menu
          </button>
        </div>
